...
public class CameraFragment extends Fragment implements SurfaceHolder.Callback, Camera.PictureCallback {
    ...
    private PictureListRVAdapter mPictureListRVAdapter;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mPicsList = (RecyclerView) view.findViewById(R.id.recycler_view);
        mCancel = (ImageView) view.findViewById(R.id.cancel_activity);
        ...
        new Thread() {
            ...
            public void run() {
                ...
                handler.post(new Runnable() {
                    ...
                    @Override
                    public void run() {
                        mPictureListRVAdapter = new PictureListRVAdapter(getContext(), getGalleryPhotos());
                        mPicsList.setLayoutManager(new LinearLayoutManager(getContext(), LinearLayoutManager.HORIZONTAL, false));
                        mPicsList.setAdapter(mPictureListRVAdapter);
                    }
                });
                Looper.loop();
            }
...
//        Log.d(TAG, "Rotate Picture by: " + rotation);
    ...
    class PictureListRVAdapter extends RecyclerView.Adapter<PictureListRVAdapter.GalleryItemViewHolder> {
        private ArrayList<CustomGallery> mList = new ArrayList<>();
        ...
        public PictureListRVAdapter(Context context, ArrayList<CustomGallery> list) {
        ...
        public GalleryItemViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            View root = inflater.inflate(R.layout.squarecamera__picture_file_layout, viewGroup, false);
            GalleryItemViewHolder holder = new GalleryItemViewHolder(root);
            return holder;
        }

        @Override
        public void onBindViewHolder(final GalleryItemViewHolder viewHolder, int i) {
            final CustomGallery galleryItem = mList.get(i);
            try {

                imageLoader.displayImage("file://" + galleryItem.sdcardPath,
                        viewHolder.mPictureImage, new SimpleImageLoadingListener() {
                            @Override
                            public void onLoadingStarted(String imageUri, View view) {
                                viewHolder.mPictureImage
            ...
            viewHolder.mParentView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Bitmap bitmap  = ((BitmapDrawable)viewHolder.mPictureImage.getDrawable()).getBitmap();
                    ...
                    getFragmentManager()
                            ...
                            .replace(
                                    R.id.fragment_container,
                                    EditSavePhotoFragment.newInstance(byteArray, 0, mImageParameters.createCopy()),
                                    EditSavePhotoFragment.TAG)
                            .addToBackStack(null)
                            .commit();
        ...
        class GalleryItemViewHolder extends RecyclerView.ViewHolder {
            ...
            public GalleryItemViewHolder(View itemView) {
                super(itemView);
                mPictureImage = (ImageView) itemView.findViewById(R.id.image);
                mParentView = (LinearLayout) itemView.findViewById(R.id.image_wrapper);
            }
        }
